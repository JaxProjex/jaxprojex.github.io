...
function SkyviewRpi({index, handleClose}) {
    ...
    function returnBody1Html() {
        return (
            <>
                <p>someting skfs dgsflaorf gtsflksaed dtyhdyrgf dcrs th tuf bv dsrcs dty yv t v</p>
                <p>
                    111111several of the years going to open for the times of that have come from over the tirteen going for m
